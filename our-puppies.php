...
<head>
    ...
    <title>Mariposas Puppies - Our Puppies</title>
...
<body>
    ...
    <div class="center">
        <div class="our-pet-card">
            <div class="additional">
                <div class="user-card">
                    ...
                    <div class="points center">
                        Age: 12 Weeks
                        <div class="stats">
                            <button class="btnBuyDog" type="button" onclick="location.href='contact-us.php';">Contact us</button>
                        </div>
                    </div>
                </div>
                <div class="more-info">
                    ...
                    <div class="coords">
                        <span><b>Vaccine:</b> <i class="fa fa-check"></i></span>
                        <span><b>Veterinary:</b> <i class="fa fa-check"></i></span>
                        <div class="geeks">
                            <img src="/img/rolf.jpg" alt="Geeks Image" />
                        </div>
                    </div>
                    <div class="stats">
                        <p>
                            <a class="btn"><span>Price: $799</span></a>
                        </p>
                    </div>
                </div>
            </div>
            <div class="general">
                <h1>Aurore</h1>
                <p>Potty Trained, Registration Papers, Veterinarian examination, Health certificate, Health guarantee, Pedigree, Travel crate.</p>
                <span class="more">Hover over for puppy info</span>
            </div>
        </div>
            ...
            <div class="additional">
                ...
                <div class="more-info">
                    ...
                    <div class="coords">
                        ...
                        <span><b>Veterinary:</b> <i class="fa fa-check"></i></span>
                        <div class="geeks">
                            <img src="/img/romeo.jpg" alt="Geeks Image" />
                        </div>
                    </div>
                    <div class="stats">
                        <p>
